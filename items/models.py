...
class Advertisement(models.Model):
    title = models.CharField(verbose_name="Название товара", max_length=70)
...
class Review(models.Model):
    ...
    author = models.ForeignKey(
        "users.User", verbose_name="Автор отзыва", on_delete=models.SET_NULL, **NULLABLE
    )
    ad = models.ForeignKey(
        Advertisement, verbose_name="Объявление", on_delete=models.SET_NULL, **NULLABLE
    )
    created_at = models.DateTimeField(verbose_name="Дата создания", auto_now_add=True)
